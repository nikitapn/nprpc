...
#
# Runs sourcekit-lsp from the Docker image, forwarding the LSP
...
exec docker run --rm -i \
  ...
  \
  `# Work inside the swift project directory SPM resolution just works` \
  -w "$PROJECT_ROOT/examples/live-blog/server" \
  \
  "$IMAGE" \
