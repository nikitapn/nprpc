...
class ShmChannel {
public:
    static constexpr size_t RING_BUFFER_SIZE = 16 * 1024 * 1024;  // 16MB per direction
    static constexpr size_t MAX_MESSAGE_SIZE = 32 * 1024 * 1024;  // 32MB max message
    ...
    bool is_open() const { return send_ring_ != nullptr && recv_ring_ != nullptr; }
