...
class ServerControlServiceImpl final
    : public grpc::benchmark::ServerControl::Service
{
...
class BenchmarkServiceImpl final : public grpc::benchmark::Benchmark::Service
{
  ...
  Status
  ProcessEmployee(ServerContext* context,
  ...
  Status
  ProcessLargeData(ServerContext* context,
...
void RunServer()
{
  ...
  std::cout << "gRPC benchmark server listening on " << server_address
            << std::endl;
