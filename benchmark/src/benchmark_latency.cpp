...
public:
  void SetUp(const ::benchmark::State& state) override {
    ...
    if (transport_ == TransportType::UDP) {
      proxy_udp_ = get_object<nprpc::benchmark::BenchmarkUDP>("nprpc_benchmark_udp");
    } else {
...
BENCHMARK_DEFINE_F(LatencyFixture, CallWithReturn)(benchmark::State& state) {
  if (transport_ == TransportType::UDP) return; // UDP doesn't support this
...
LatencyFixture/EmptyCall/3              130 us         19.5 us        36789  49.999k/s UDP
...
LatencyFixture/CallWithReturn/3         125 us         19.0 us        36789  49.999k/s UDP
-------------------------------------------------------------------------------------------------------
...
LatencyFixture/SmallStringCall/3        130 us         18.5 us        36789      4.99999Mi/s 49.999k/s UDP
*/