...
public enum detail {
  public struct ObjectIdLocal: Codable, Sendable   {
    public var poa_idx: poa_idx_t
    public var object_id: oid_t
  ...
  public func marshal_ObjectId(buffer: UnsafeMutableRawPointer, offset: Int, data: ObjectId)   {
    ...
    NPRPC.marshal_string(buffer: buffer, offset: offset + 28, value: data.class_id)
    NPRPC.marshal_string(buffer: buffer, offset: offset + 36, value: data.urls)
  }
...
result.urls = NPRPC.unmarshal_string(buffer: buffer, offset: offset + 36)
    ...
    public enum impl     {
      ...
      public struct Header: Codable, Sendable       {
        ...
        public var msg_id: MessageId
        public var msg_type: MessageType
        public var request_id: UInt32
      ...
      public struct CallHeader: Codable, Sendable       {
        public var poa_idx: poa_idx_t
        public var interface_idx: ifs_idx_t
        public var function_idx: fn_idx_t
        public var object_id: oid_t
      ...
      public enum StreamMessageType: Int       {
        case sTREAM_INIT = 0
        case sTREAM_CHUNK = 1
      ...
      public struct StreamInit: Codable, Sendable       {
        public var stream_id: UInt64
        public var poa_idx: poa_idx_t
        public var interface_idx: ifs_idx_t
        public var object_id: oid_t
        public var func_idx: fn_idx_t
...
result.data = NPRPC.unmarshal_fundamental_vector(buffer: buffer, offset: offset + 16)
        ...
        public struct StreamComplete: Codable, Sendable         {
          public var stream_id: UInt64
          public var final_sequence: UInt64
