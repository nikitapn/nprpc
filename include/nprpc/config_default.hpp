...
// HTTP/3 response compression (gzip/deflate). Off unless asked for; bodies
// smaller than the minimum are sent as-is, since the coding overhead and the
// CPU are not worth it there.
#define NPRPC_DEFAULT_HTTP3_COMPRESSION_ENABLED false
#define NPRPC_DEFAULT_HTTP3_COMPRESSION_MIN_SIZE 256
