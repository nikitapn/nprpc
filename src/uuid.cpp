...
struct SharedUUID::Impl {
  ...
  Data* data() { return static_cast<Data*>(map_region); }

  uuid_array& uuid_ref() { return data()->uuid; }
  ...
  Impl()
  {
    ...
    file_mapping = CreateFileMappingA(INVALID_HANDLE_VALUE, // Use paging file
    ...
    // Map view of file
    map_region = MapViewOfFile(file_mapping,        // Handle to mapping object
    ...
    map_region = mmap(nullptr, sizeof(Data), PROT_READ | PROT_WRITE, MAP_SHARED,
                      shm_fd, 0);
