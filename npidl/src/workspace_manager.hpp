...
struct ProjectContext {
  ...
  bool is_related_to(const std::string& uri,
                     const std::vector<std::string>& file_imports) const
  {
...
public:
  ...
  ProjectContext* get_project_for_file(const std::string& uri,
...
private:
  ...
  ProjectContext* find_related_project(const std::string& uri,
                                       const std::vector<std::string>& imports);
};
